...
function AboutPage(){
    ...
    return(
        <div>
            ...
            <div><Collapse title={"Fiabilité"} description="Les annonces postées sur Kasa garantissent une fiabilité totale. 
                Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes." /></div>
            <div><Collapse title={"Respect"} description="La bienveillance fait parties des valeurs fondatrices de Kasa.
                Tout comportement discriminatoire ou de pertubation du voisinage entraînera une exclusion de notre plateforme." /></div>    
            <div><Collapse title={"Service"} description="Nos équipes se tiennent à votre disposition pour vous fournir
             une expérience parfaite" /></div>  
            <div><Collapse title={"Sécurité"} description="La sécurité est la priorité de Kasa. Aussi bien pour nos hôtes que pour
